...
int main()
{
	...
	*/
    ...
    std::string f_n{ "./resources/textures/forest.png" };

	Texture brickTex( f_n.c_str() , GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	brickTex.AssignUnit(shaderProgram, "tex0", 0);
